...
function (_Component) {
  ...
  _createClass(IndexPage, [{
    ...
    value: function render() {
      ...
      }, "Welcome to Sentimental Chat"), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("span", {
        style: {
          color: '#ddd'
        },
        __source: {
      ...
      }, this.state.user)) : "Enter a username"), !user && __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("input", {
        type: "text",
...
//# sourceMappingURL=4.cff9a547c5356b6cdb01.hot-update.js.map